...
public class NotenverwaltungGUI extends JFrame {
  ...
  // Erstellen des Note Ändern Button              
  ...
  public NotenverwaltungGUI(String title, File datei) {
    ...
    //#Feature2: Festlegen der Eigenschaften und Einfügen auf das Panel
    //Zur Löschen Funktion
    btnNoteloeschen.setBounds(294, 24, 91, 25);
    btnNoteloeschen.setText("Note löschen");
    ...
    btnNoteAendern.setText("Note Ändern");
  ...
  public void aktualisiereDaten(File datei) {
    ...
    //#Fehler3: Zum Verhindern der Hinzufügung von Noten ohne Fach, wird der Button deaktiviert
    ...
    //#Fehler1: Der Inhalt der Combobox wird vor dem Einfügen des neuen Inhalts entfernt
    ...
    //Datei öffnen Button koordinaten konfiguriet von x=304 zu x=294
    ...
    //#Feature2: Wiederholtes einfügen der Elemente auf das Panel 
    pnl_Noten.add(btnNoteloeschen);
    pnl_Noten.add(nfdNoteStelle);
    pnl_Noten.add(nfdNoteFach);
    pnl_Noten.add(lblNoteFach);
  ...
  private void cbx_Fach_ausgewaehlt_ActionPerformed(ActionEvent evt) {
    ...
    pnl_Noten.add(btn_File_waehlen);
    //#Feature2: Fügt die Objekte erneut zum Panel hinzu
    pnl_Noten.add(btnNoteloeschen);
    pnl_Noten.add(nfdNoteStelle);
    pnl_Noten.add(nfdNoteFach);
    pnl_Noten.add(lblNoteFach);
  ...
  public void btn_Fach_hinzufuegen_ActionPerformed(ActionEvent evt) {
    //#Fehler5: Um bei einem ungültigen Fachnamen eine Fehlermeldung zu verhindern, wird das 1. Zeichen auf eine Zahl oder Sonderzeichen erfragt & zum Verhindern von ungültigen Wunschnoten
  ...
  public void btn_Note_hinzufuegen_ActionPerformed(ActionEvent evt) {
    ...
    //#Fehler4: Es wird erst überprüft ob das Numberfield eine Zahl beinhaltet
    int notenpunkte = 0;
  ...
  //#Feature2: Neue Methode zum aufrufen der Notenlöschmethode in NV 
  ...
  //#Feature2: Neue Methode zum aufrufen der NotenÄndernmethode in NV
