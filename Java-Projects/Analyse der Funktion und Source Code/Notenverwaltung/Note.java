...
public class Note{
  ...
  public Note(int np, String eL, boolean isKlausur){
    ...
    this.gewichtung = 0;  //0 ist die Kennzeichung f?r gleich wichtig
    this.isKlausur = isKlausur;//Kennzeichnung als Klausur zur sp?teren Endnotenberechung
  }
  ...
  //das Schl?sselwort static kennzeichnet die Methode als Objektunabh?ngig
