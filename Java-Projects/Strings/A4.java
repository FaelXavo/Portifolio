...
class A4{
   ...
   * Falls die Zeichenkette nicht ausschließlich Ziffern enthält, wird 0 zurückgegeben.
   * @parameter value ist die Eingabezeichenkette, die nur Ziffern enthalten sollte.
   * @return die Summe der Ziffern oder 0, wenn ungültige Zeichen enthalten sind.
   */
