...
public class computer_haendler extends JFrame {
  // start attributes
  ...
  public computer_haendler() { 
    ...
    setVisible(true);
  } // end of public computer_haendler
  
  // start methods
  
  public static void main(String[] args) {
    new computer_haendler();
  } // end of main
  ...
  // end methods
} // end of class computer_haendler
